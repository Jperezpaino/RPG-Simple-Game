...
import es.noa.rad.game.engine.core.component.GamePanel;
  ...
  public class TileManager {
    ...
    public final Tile getTile(
        final int _index) {
      return this.tiles[_index];
    }

    /**
     * @param _index {@code int}
     * @param _tile {@code Tile}
     */
    public final void setTile(
        final int _index,
        final Tile _tile) {
      this.tiles[_index] = _tile;
    }

    /**
     * @return {@code int[][]}
     */
    public final int[][] getMapTileData() {
      return this.mapTileData;
    }

    /**
     * @param _mapTileData {@code int[][]}
     */
    public final void setMapTileData(
        final int[][] _mapTileData) {
      this.mapTileData = _mapTileData;
    }

    /**
     * @param _colunm {@code int}
     * @param _row {@code int}
     * @return {@code int}
     */
    public final int getMapTileData(
        final int _colunm,
        final int _row) {
      return this.mapTileData[_colunm][_row];
    }

    /**
     * @param _colunm {@code int}
     * @param _row {@code int}
     * @param _value {@code int}
     */
    public final void setMapTileData(
        final int _colunm,
        final int _row,
        final int _value) {
      this.mapTileData[_colunm][_row] = _value;
    }
