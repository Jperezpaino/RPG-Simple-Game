      ...
      try {
        super.setUp(
          ImageIO.read(this.getClass().getResourceAsStream(
            "/assets/entity/player/link/walk/up.png")));
        super.setDown(
          ImageIO.read(this.getClass().getResourceAsStream(
            "/assets/entity/player/link/walk/down.png")));
        super.setLeft(
          ImageIO.read(this.getClass().getResourceAsStream(
            "/assets/entity/player/link/walk/left.png")));
        super.setRight(
          ImageIO.read(this.getClass().getResourceAsStream(
            "/assets/entity/player/link/walk/right.png")));
      } catch (
