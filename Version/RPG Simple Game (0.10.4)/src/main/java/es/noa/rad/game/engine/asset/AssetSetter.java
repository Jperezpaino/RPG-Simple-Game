...
import es.noa.rad.game.engine.asset.object.FeatherObject;
...
import es.noa.rad.game.engine.core.component.GamePanel;
  ...
  public class AssetSetter {
    ...
    public final void setObject() {
      ...
      final FeatherObject featherObject = new FeatherObject();
      featherObject.setWorldX(5 * this.gamePanel.getTileSize());
      featherObject.setWorldY(24 * this.gamePanel.getTileSize());
      this.gamePanel.setObject(3, featherObject);
      ...
      this.gamePanel.setObject(4, doorOneObject);
      ...
      this.gamePanel.setObject(5, doorTwoObject);
    }
