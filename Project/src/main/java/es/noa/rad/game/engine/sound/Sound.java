...
import javax.sound.sampled.Clip;
  ...
  public class Sound {
    ...
    public Sound() {
      ...
      this.soundURL[1]
        = this.getClass().getResource("/assets/sound/effects/coin.wav");
      this.soundURL[2]
        = this.getClass().getResource("/assets/sound/effects/powerup.wav");
      this.soundURL[3]
        = this.getClass().getResource("/assets/sound/effects/unlock.wav");
    }
